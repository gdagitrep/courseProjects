...
public class ResourceManagerImpl
	...
	{ return "ResInterface.ResourceManager"; }
	...
	public static void main(String args[]) {
	 ...
	 try 
		 ...
		 CharonROManager crom = new CharonROManager(Integer.parseInt(System.getenv("SRVR_RO_PORT")));
		 // create a new Server object
		 ResourceManager obj = new ResourceManagerImpl();
		 // dynamically generate the stub (client proxy)
		 crom.registerObject(System.getenv("SRVR_RO_OBJ_NAME"), obj);
	 ...
	 public ResourceManagerImpl() throws CharonException {
	 }
...
//	
	...
	public boolean reserveCar(int id, int customerID, String location)
		throws CharonException
	{
	  Trace.info("RM::reserveCar(" + id + ", " + location + ") called" );
