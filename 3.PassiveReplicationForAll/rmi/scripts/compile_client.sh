...
rm ${CLIENT_SRC}/jango.jar
ln -s ${TOOLS}/jango.jar ${CLIENT_SRC}/jango.jar

rm ${CLIENT_SRC}/TxSystem.jar
ln -s ${TX_SRC}/TxSystem.jar ${CLIENT_SRC}/TxSystem.jar

${JAVAC} -cp ${CLIENT_SRC}/jango.jar:${CLIENT_SRC}/G13Shared.jar:${TX_SRC}/TxSystem.jar:${CLIENT_SRC}/MWInterface.jar ${CLIENT_SRC}/*.java
