...
public class client
{
    ...
    public static void main(String args[])
	{
	    ...
	    try 
		{
				rm = (MWLayer) CharonROManager.getRemoteObjectReference(System.getenv("MIDW_RO_REGISTRY_HOST"), Integer.parseInt(System.getenv("MIDW_RO_PORT")), System.getenv("MIDW_RO_OBJ_NAME"));
	...
	switch(findChoice(command))
		...
		System.out.println("\tdeleteroom,<id>,<location>");
		break;
		...
		System.out.println("\nUsage:");
		System.out.println("\titinerary,<id>,<customerid>,<flightnumber1>....<flightnumberN>,<LocationToBookCarsOrRooms>,<BookCars?>,<BookRooms?>");
		break;
