...
public class ResourceManager_RepStub extends JangoRepStub<ResourceManager> implements ResourceManager
{
	public ResourceManager_RepStub(String rmiHosts[], String srvrNames[], int rmiPorts[])
	{ super(rmiHosts, srvrNames, rmiPorts, JANGO_MAX_HASH_BUCKET_SIZE, -1); }

	public ResourceManager_RepStub(String rmiHosts[], String srvrNames[], int rmiPorts[], int maxHashBucketSize)
	{ super(rmiHosts, srvrNames, rmiPorts, maxHashBucketSize, -1); }

	public ResourceManager_RepStub(String rmiHosts[], String srvrNames[], int rmiPorts[], int maxHashBucketSize, int maxRetries)
	{ super(rmiHosts, srvrNames, rmiPorts, maxHashBucketSize, maxRetries); }

	public ResourceManager_RepStub(int numReplics, String replicConfigs)
	{ super(numReplics, replicConfigs, JANGO_MAX_HASH_BUCKET_SIZE, -1); }

	public ResourceManager_RepStub(int numReplics, String replicConfigs, int maxHashBucketSize)
	{ super(numReplics, replicConfigs, maxHashBucketSize, -1); }

	public ResourceManager_RepStub(int numReplics, String replicConfigs, int maxHashBucketSize, int maxRetries)
	...
	public boolean reserveFlight(int arg_0,int arg_1,int arg_2,int arg_3,boolean arg_4) throws java.rmi.RemoteException, TxSystem.InvalidTransactionException, TxSystem.TransactionAbortedException, TxSystem.DeadlockException
	{
		int retries=0;
		int srvrIdx = hash(arg_0);
		java.rmi.RemoteException eR;
		do
		{
			try{ return getSrvr(srvrIdx).reserveFlight( arg_0, arg_1, arg_2, arg_3, arg_4);  }
			catch(java.rmi.RemoteException e)
			{
				System.out.println("Exception:" + e);
				eR = e;
	...
	public boolean reserveCar(int arg_0,int arg_1,int arg_2,java.lang.String arg_3,boolean arg_4) throws java.rmi.RemoteException, TxSystem.InvalidTransactionException, TxSystem.TransactionAbortedException, TxSystem.DeadlockException
	{
		int retries=0;
		int srvrIdx = hash(arg_0);
		java.rmi.RemoteException eR;
		do
		{
			try{ return getSrvr(srvrIdx).reserveCar( arg_0, arg_1, arg_2, arg_3, arg_4);  }
			catch(java.rmi.RemoteException e)
			{
				System.out.println("Exception:" + e);
				eR = e;
	...
	public boolean reserveRoom(int arg_0,int arg_1,int arg_2,java.lang.String arg_3,boolean arg_4) throws java.rmi.RemoteException, TxSystem.InvalidTransactionException, TxSystem.TransactionAbortedException, TxSystem.DeadlockException
	{
		int retries=0;
		int srvrIdx = hash(arg_0);
		java.rmi.RemoteException eR;
		do
		{
			try{ return getSrvr(srvrIdx).reserveRoom( arg_0, arg_1, arg_2, arg_3, arg_4);  }
			catch(java.rmi.RemoteException e)
			{
				System.out.println("Exception:" + e);
				eR = e;
