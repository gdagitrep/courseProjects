...
public class client
{
    ...
    public static void main(String args[])
	{
		...
		case 17:  //reserve a flight
			...
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_FLIGHT, null, customer+"-"+flightNum,PerfMonitor.START);
			rc=rm.reserveFlight(txid,customer,flightNum);
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_FLIGHT, null, customer+"-"+flightNum,PerfMonitor.END);
			if(rc)
		...
		case 18:  //reserve a car
			...
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_CAR, null, customer+"-"+location,PerfMonitor.START);
			rc = rm.reserveCar(txid,customer,location);
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_CAR, null, customer+"-"+location,PerfMonitor.END);
			if(rc)
		...
		case 19:  //reserve a room
			...
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_HOTEL, null, customer+"-"+location,PerfMonitor.START);
			rc = rm.reserveRoom(txid,customer,location);
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_HOTEL, null, customer+"-"+location,PerfMonitor.END);
			if(rc)
		...
		case 20:  //reserve an Itinerary
			...
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_ITINERARY, null,customer+"-"+location,PerfMonitor.START);
			rc=rm.itinerary(txid,customer,flightNumbers,location,Car,Room);
			PerfMonitor.recordPerf(txid, PerfMonitor.REQUEST_RESERVE_ITINERARY, null,customer+"-"+location,PerfMonitor.END);
			if(rc)
