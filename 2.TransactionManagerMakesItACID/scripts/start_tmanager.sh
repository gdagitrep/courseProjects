...
nohup java -Djava.rmi.server.useCodebaseOnly=false -Djava.rmi.server.codebase=file:///${TX_SRC}/ -Djava.security.policy=${SRC512_HOME}/tmanager.policy -cp ${TX_SRC}/TxIntf.jar:${TX_SRC}/TxSystem.jar:${TX_SRC}/G13Shared.jar:${TX_SRC}: TxImp.TxnManager  > ${LogFile} 2>&1 &
cpid=$!
